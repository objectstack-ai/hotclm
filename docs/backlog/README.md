...
| [02](./02-contract-domain.md) | Contract domain: `clm_contract`, `clm_contract_version`, `clm_review`, `clm_deviation`, `clm_seal_request` + state-machine hooks | M1 | — |
...
| [06](./06-approval-ladder.md) | F5 approval ladder · F7 seal request approval | M2 | 04 |
...
| [11](./11-i18n.md) | Translations `zh-CN` (default) and `en` | M3 | 07 |
| [12](./12-esign-and-crm-handoff.md) | F8 e-signature connector · F15 HotCRM hand-off behind `CLM_COMPOSITION` | M4 | 06, 09 |
| [13](./13-ai-skills.md) | S1–S4 skills with honest degradation | M4 | 05 |
